	...
	<div class="container">
		...
		<div id="navbar" class="navbar-collapse collapse">
			...
			<ul class="nav navbar-nav main-nav"> 
				...
				<li class="dropdown drop-menu-mob <?php if($action=='about' || $action=='events' || $action=='news-paper' || $action=='our-motto' || $action=='directors-desk'){echo 'active';} ?>">
					<a href="#" data-toggle="dropdown" class="dropdown-toggle <?php if($action=='about' || $action=='events' || $action=='news-paper' || $action=='our-motto' || $action=='directors-desk'){echo 'active';} ?>">About Us <b class="caret"></b></a>
