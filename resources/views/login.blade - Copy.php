...
<head>
        ...
        <title>Welcome to Tektriangle</title>
    ...
    <body>
        ...
        <div class="wrapper-page">
            ...
            <div class="panel-heading"> 
                <h3 class="text-center"> Sign In to <strong class="text-custom">Tektriangle</strong> </h3>
            </div> 


            <div class="panel-body">
            <form class="form-horizontal m-t-20" action="http://coderthemes.com/ubold_1.2/light/index.html">
