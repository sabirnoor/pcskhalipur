...
<section class="mb-4">
  ...
  <div class="row">
      ...
      <div class="col-md-12 mb-md-0 mb-5">
          <form id="feedback-form" name="feedback-form" action="{{url('feedback')}}" method="POST" autocomplete="on">
            {{csrf_field()}}
              <!--Grid row-->
              <div class="row">
                  <!--Grid column-->
                  <div class="col-md-6">
                      <div class="md-form mb-0">
                        <label for="student_name" class="">Student name <span style="font-size:15px;color: red;">*</span></label></label>
                          <input type="text" id="student_name" name="student_name" readonly class="form-control" value="{{$dataSession['student_name']}}" autocomplete="off">
                  ...
                  <div class="col-md-6">
                      <div class="md-form mb-0">
                        <label for="admission_no" class="">Admission No. <span style="font-size:15px;color: red;">*</span></label></label>
                          <input type="text" id="admission_no" name="admission_no" readonly class="form-control" value="{{$dataSession['admission_no']}}" autocomplete="off">
                  ...
                  <div class="col-md-6">
                      <div class="md-form mb-0">
                        <label for="roll_no_previous" class="">Roll No Previous Class <span style="font-size:15px;color: red;">*</span></label></label>
                          <input type="text" id="roll_no_previous" name="roll_no_previous" readonly class="form-control" value="{{$dataSession['roll_no_previous']}}" autocomplete="off">
                      </div>
                  </div>
                  <div class="col-md-6">
                      <div class="md-form mb-0">
                        <label for="present_class" class="">Present Class <span style="font-size:15px;color: red;">*</span></label></label>
                          <input type="text" id="present_class" name="present_class" readonly class="form-control" value="{{$dataSession['present_class']}}" autocomplete="off">
                      </div>
                  </div>
                  <div class="col-md-6">
                      <div class="md-form mb-0">
                        <label for="contact_no" class="">Contact No <span style="font-size:15px;color: red;">*</span></label></label>
                          <input type="text" id="contact_no" name="contact_no" readonly class="form-control" value="{{$dataSession['contact_no']}}" autocomplete="off">
                      </div>
                  </div>
                  <div class="col-md-6">
                      <div class="md-form mb-0">
                        <label for="whatsapp_no" class="">Whatsapp No <span style="font-size:15px;color: red;">*</span></label></label>
                          <input type="text" id="whatsapp_no" name="whatsapp_no" readonly class="form-control" value="{{$dataSession['whatsapp_no']}}" autocomplete="off">
                      </div>
                  </div>
                  <div class="col-md-12">
                      <div class="md-form mb-0">
